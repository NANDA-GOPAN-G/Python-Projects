"""
A Tic-Tac-Toe game with simple AI coded in python.
"""
    ...
    while run:
        ...
        try:
            ...
            if move > 0 and move < 10:
                ...
                print("Please select a position within the range(1-9)!")
        except:
            print("Please type a number(integer)!")
...
def main():
    ...
    print("--------------------------------")
    print(f"{player} vs Computer... BEGIN!!!")
    print("--------------------------------")
    ...
    while not(isBoardFull(board)):
        if not(isWinner(board, 'O')):
            ...
            print("OOPS! Computer won this time! Better Luck Next Time..")
            break
        ...
        if not(isWinner(board, 'X')):
            ...
            print(f"{player} won this time! Good Job..")
            break
...
while True:
    answer = input("ARE YOU READY TO PLAY THE GAME: (Y/N)")
